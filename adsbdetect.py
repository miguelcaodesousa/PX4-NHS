...
Run (example):
  PX4_IP=172.17.24.175 PX4_PORT=14620 LOCAL_PORT=14621 ICAO_HEX=0x70001 python3 adsbdetect.py
"""
...
SYSID       = int(os.getenv("SYSID", "246"))          # detector sysid
COMPID      = int(os.getenv("COMPID", str(mavlink2.MAV_COMP_ID_ONBOARD_COMPUTER)))
ICAO_HEX    = os.getenv("", "").strip()       # e.g., "0x70001" or decimal; empty = ANY
...
# -------------------------
# Heartbeat @ 1 Hz (MAVLink v2)  **ONLY CHANGE IS HERE**
# -------------------------
